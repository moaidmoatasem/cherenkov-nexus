...
mindmap
  root((CHERENKOV-NEXUS))
    Core Ingestion & Tailoring
      [Job Synthesizer: Split-Screen Reality vs AST]
      [Live Git Diff Overlay]
      [Instant CopyBlock Ergonomics]
    Compliance & Legal Intelligence
      [UK Home Office Deterministic Sponsor Check]
      [EU Blue Card & IND 30% Ruling Verification]
      [Minimum Salary Threshold Validator]
    Continuous Upskilling
      [xAPI LRS Webhook Ingestion]
      [Automated Skill Gap Analysis]
      [Live Competency Matrix Sync]
    Strategic Outreach & Prep
      [Adversarial Audio Interview Sandbox]
      [LinkedIn & GitHub Engineering Scout]
      [RFC 6068 Mailto Instant Pitch Generator]
    Edge AI & Multi-Model
      [Zero-Trust In-Browser WebGPU Inference]
      [Model Compare Benchmarking Hub]
      [Hardware Scanner: WebGPU & WebUSB Keys]
    Control Plane Navigation
      [Global Cmd+K Command Palette]
      [Drag & Drop Kanban Pipeline]
      [Theme Aura Background Engine]
```
