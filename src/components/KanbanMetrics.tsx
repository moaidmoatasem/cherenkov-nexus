...
export const KanbanMetrics: React.FC<KanbanMetricsProps> = ({ applications }) => {
  ...
  return (
    <div className="p-6 rounded-3xl bg-gradient-to-br from-[#0c101a] via-[#090d16] to-[#06080e] border border-violet-500/25 shadow-2xl space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3.5">
        <div className="p-4 rounded-2xl bg-white/[0.02] border border-white/[0.06] flex flex-col justify-between">
          ...
          <span className="text-[10px] text-slate-500 mt-1">Saved $\rightarrow$ Interview rate</span>
        </div>
